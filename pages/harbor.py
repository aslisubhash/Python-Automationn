...
class Harbor:
    ...
    def enrollment(self):
        ...
        term_applying_VALUE = 'CAP_4266'
        select_education_Goal_ID = 'inputEduGoal'
        education_Goal_VALUE = 'O'
        select_major_category_ID = 'inputMajorCategory'
        major_category_VALUE = 'Science/Technology/Engineering/Mathematics'
        select_program_ID = 'inputMajorId'
        program_VALUE = 'CAP_9459'
        time.sleep(2)
        ...
        self.perform.set_select_by_ID(select_major_category_ID, major_category_VALUE)
    ...
    def education_page(self):
        ...
        last_HS_country = 'US'
        last_HS_state = 'CA'
        last_HS_name = 'California High School'
        last_HS_city = 'Los Angeles'
        ...
        self.perform.click_button_by_ID('inputCaHsGradYes')
        # self._click_button_by_ID('inputCaHsGradNo')
        # self._click_button_by_ID('inputCaHs3yearNo')
        self.perform.click_button_by_ID('inputCaHs3yearYes')
        ...
        self.perform.set_input_by_ID('inputGPA', '3.72')
    ...
    def residency_page(self):
        ...
        self.perform.click_button_by_ID('inputCaOutsideTax')
        time.sleep(2)
        self.perform.set_input_by_ID('inputCaOutsideTaxYear', '2019')

        # Special Residency Categories
        try:
            self.perform.click_button_by_ID('inputCaCollegeEmpNo')
            self.perform.click_button_by_ID('inputCaSchoolEmpNo')
            self.perform.click_button_by_ID('inputHomelessYouthNo')
            self.perform.click_button_by_ID('inputCaSeasonalAgNo')
    ...
    def needs_interests_page(self):
        ...
        self.perform.click_button_by_ID('inputAthleticInterest1')

        # program_and service stuff...
        self.perform.click_button_by_ID('inputCounseling')
        self.perform.click_button_by_ID('inputEOPS')
        self.perform.click_button_by_ID('inputHealthServices')
    ...
    def demographic_page(self):
        ...
        # parent education
        self.perform.set_select_by_ID('inputParentGuardianEdu1', '7')
        self.perform.set_select_by_ID('inputParentGuardianEdu2', '2')
    ...
    def supplemental_question_page(self):
        ...
        self.perform.set_select_by_ID('_supp_MENU_21', '0')
        ...
        # if yes
        self.perform.set_select_by_ID('_supp_MENU_5', 'BADMIC')
